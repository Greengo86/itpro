            ...
            <div class="row">
                <div class="col-md-3 col-sm-5 col-xs-5">
                    <div id="templatemo_logo">
                        <h1><a href="/"><img scr="/images/logo1.png" alt=""></a></h1>
                    </div> <!-- /.logo -->
                </div> <!-- /.col-md-4 -->
                <div class="col-md-2 col-sm-2 col-xs-2">
                    <div id="phone_number">
                        <p class="phone" id="blink7">+7 9102585258</p>
                    </div>
                </div>
    ...
    <ul class="bxslider">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <div class="slider-caption">
                            <h2>IT-nnPRO <br> Ремонт и настройка смартфонов</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            ...
            <div class="container caption-wrapper">
                <div class="slider-caption">
                    <h2>IT-nnPRO <br> Ремонт и настройка ноутбуков</h2>
                </div>
            </div>
        </li>
        <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <div class="slider-caption">
                            <h2>IT-nnPRO <br> Ремонт и настройка планшетов</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <div class="slider-caption">
                            <h2>IT-nnPRO <br> Ремонт и настройка компьютеров</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <div class="slider-caption">
                            <h2>IT-nnPRO <br> Создание и поддержка сайта</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p>Работа на проффесиональном оборудовании и с качественными запчастями</p>
                </div> <!-- /.service-item -->
            </div> <!-- /.col-md-3 -->
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="section-title">Сервис</h1>
            </div> <!-- /.col-md-12 -->
        </div> <!-- /.row -->
        <div class="row">
            <div class="col-md-2 col-sm-3">
                <div class="item-small">
                    <img src="images/promotion/promotion1.jpg" alt="Ремонт разбитого тача">
                    <h4>Модульный ремонт</h4>
                </div> <!-- /.item-small -->
            </div> <!-- /.col-md-2 -->
            <div class="col-md-8 col-sm-6">
                <div class="item-large">
                    <img src="images/promotion/promotion2.jpg" alt="Возможные неисправности">
                </div> <!-- /.item-large -->
            </div> <!-- /.col-md-8 -->
            <div class="col-md-2 col-sm-3">
                <div class="item-small">
                    <img src="images/promotion/promotion3.jpg" alt="Ремонт дисплея">
                    <h4>Компонентный ремонт</h4>
                </div> <!-- /.item-small -->
            </div> <!-- /.col-md-2 -->
        </div> <!-- /.row -->
    </div> <!-- /.container -->
                    ...
                    <div class="item-thumb">
                        <div class="overlay">
                            <div class="overlay-inner">
                                <a href="#nogo" class="view-detail">Замена тачскрина, микрофона, динамика, кнопки включения и звука</a>
                            </div>
                        </div> <!-- /.overlay -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-item">
                    <div class="item-thumb">
                        <div class="overlay">
                            <div class="overlay-inner">
                                <a href="#nogo" class="view-detail">Программная настройка </a>
                            </div>
                        </div> <!-- /.overlay -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-item">
                    <div class="item-thumb">
                        <div class="overlay">
                            <div class="overlay-inner">
                                <a href="#nogo" class="view-detail">Ремонт и замена компонентов системной платы</a>
                            </div>
                        </div> <!-- /.overlay -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-item">
                    <div class="item-thumb">
                        <div class="overlay">
                            <div class="overlay-inner">
                                <a href="#nogo" class="view-detail">Ремонт планшета</a>
                            </div>
                        </div> <!-- /.overlay -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-item">
                    <div class="item-thumb">
                        <div class="overlay">
                            <div class="overlay-inner">
                                <a href="#nogo" class="view-detail">Ремонт компьютера</a>
                            </div>
                        </div> <!-- /.overlay -->
...
<div class="site-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-6">
                    <span id="copyright">
                    	Copyright &copy; 2016 <a href="#">IT-nnPRO</a>
                    </span>
